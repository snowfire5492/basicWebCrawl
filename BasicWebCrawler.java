...
public class BasicWebCrawler {
    ...
    public void producePage(Document Doc) throws IOException {
    	...
    	File file = new File("/Users/snowf/Desktop/repository/html_"+ links.size() + ".html");
	...
	public static void cleanDirectory() {
		for(File file: new java.io.File("/Users/snowf/Desktop/repository").listFiles()) 
		    if (!file.isDirectory()) 
		        file.delete();
	}
	
    public static void main(String[] args) throws InterruptedException, IOException {		
    		String csvFile = "/Users/snowf/Desktop/WebCrawler/source.csv";
